...
w3 = Web3(Web3.HTTPProvider(os.environ.get("POLYGON_PROVIDER")))
router_contract_address = "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D"
...
async def uniswap_check_impermanent_loss(request):
    ...
    token_price = uniswap_router.functions.getAmountsOut(
        w3.toWei(1, 'ether'),
        [weth, wmatic]
    ).call()
